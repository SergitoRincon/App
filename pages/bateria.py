...
def build(page, C, go_home, navigate_to, vehiculo_id_ref):
    ...
    return build_mant_page(
        ...
        ft.Icons.BATTERY_CHARGING_FULL, "Batería", "bateria", vehiculo_id_ref,
        [
            ("INFORMACIÓN", [
                ("marca", ft.TextField(label="Marca", hint_text="Ej: Yuasa, Motobatt...",
                                prefix_icon=ft.Icons.LABEL,
                                border_color=c["BORDER"], focused_border_color=c["ACCENT"],
                                label_style=ft.TextStyle(color=c["GRAY"]),
                                color=c["WHITE"], bgcolor=c["CARD"], border_radius=10)),
                ("referencia", ft.TextField(label="Referencia", hint_text="Ej: YTX7L-BS...",
                                prefix_icon=ft.Icons.NUMBERS,
                                border_color=c["BORDER"], focused_border_color=c["ACCENT"],
                                label_style=ft.TextStyle(color=c["GRAY"]),
                                color=c["WHITE"], bgcolor=c["CARD"], border_radius=10)),
                ("voltaje", ft.TextField(label="Voltaje", hint_text="Ej: 12V",
                                prefix_icon=ft.Icons.ELECTRIC_BOLT,
                                border_color=c["BORDER"], focused_border_color=c["ACCENT"],
                                label_style=ft.TextStyle(color=c["GRAY"]),
                                color=c["WHITE"], bgcolor=c["CARD"], border_radius=10)),
                ("amperaje", ft.TextField(label="Amperaje (Ah)", hint_text="Ej: 6Ah",
                                prefix_icon=ft.Icons.NUMBERS,
                                border_color=c["BORDER"], focused_border_color=c["ACCENT"],
                                label_style=ft.TextStyle(color=c["GRAY"]),
                                color=c["WHITE"], bgcolor=c["CARD"], border_radius=10)),
